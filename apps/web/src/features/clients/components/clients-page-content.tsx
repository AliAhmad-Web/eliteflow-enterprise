...
import { useClientStats, useClients } from "../hooks/use-clients";
...
export function ClientsPageContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        title="Clients"
        description="Manage companies, contacts, and relationship status across EliteFlow."
        ...
        <CardContent className="space-y-4 p-4 sm:p-5">
          <div className="enterprise-toolbar static! border-0 bg-muted/25 p-3 shadow-none sm:p-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <select
                ...
                value={status}
                onChange={(event) => {
                  setStatus(event.target.value as ClientStatusValue | "ALL");
                  setPage(1);
                }}
              >
          ...
          {!showInitialLoading && !isError ? (
            <>
              ...
              {clients.length === 0 && !deferredSearch && status === "ALL" ? (
                <EmptyState
